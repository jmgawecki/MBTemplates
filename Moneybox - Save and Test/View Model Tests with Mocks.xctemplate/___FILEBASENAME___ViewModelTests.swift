...
final class ___VARIABLE_moduleName___ViewModelTests: MBXCTestCase {
    var sut: ___VARIABLE_moduleName___ViewModel!
    var coordinator: ___VARIABLE_moduleName___CoordinatorMock!
    var viewController: ___VARIABLE_moduleName___ViewControllerMock!
    
    override func setUp() {
        super.setUp()
        coordinator = ___VARIABLE_moduleName___CoordinatorMock()
        viewController = ___VARIABLE_moduleName___ViewControllerMock()
        sut = /*@START_MENU_TOKEN@*/___VARIABLE_moduleName___ViewModel()/*@END_MENU_TOKEN@*/
...
extension ___VARIABLE_moduleName___ViewModelTests {
    // Test your ___VARIABLE_moduleName___ViewModel here
